# 05 · UI 设计 · PCL 风格(SolidJS + CSS 落地)

> 选定走 PCL 风格。本文从 PCL2 源码扒出它的设计语言,翻译成我们 Tauri + SolidJS 前端的设计系统。
> 提取自 `ref/PCL2/Plain Craft Launcher 2/Application.xaml`、`FormMain.xaml`、`Controls/My*`。

---

## 1. PCL 之所以是 PCL —— 设计语言提炼
