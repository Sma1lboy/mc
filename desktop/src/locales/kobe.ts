...
const dict = {
  zh: {
    ...
    autoLogin: "自动登录",
    autoShort: "自动",
    autoLoginOn: "已设为自动登录,点击取消",
    autoLoginOff: "点击设为自动登录",
    forget: "移除此账号",
    useAnother: "用其它账号登录 / 注册",
    working: "处理中…",
  ...
  en: {
    ...
    autoShort: "Auto",
    autoLoginOn: "Auto-login is on — click to turn off",
    autoLoginOff: "Click to auto-login with this account",
    forget: "Forget this account",
    useAnother: "Use another account / sign up",
    working: "Working…",
