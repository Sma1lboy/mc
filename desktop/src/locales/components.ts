...
const dict = {
  zh: {
    ...
    "export.fmtModrinth": "Modrinth 整合包 (.mrpack)",
    "export.fmtCurseforge": "CurseForge 整合包 (.zip)",
    "export.fmtModlist": "Mod 清单",
    "export.subMd": "Markdown (.md)",
    "export.subHtml": "网页 (.html)",
    "export.subJson": "JSON (.json)",
    "export.subCsv": "CSV (.csv)",
    "export.subTxt": "纯文本 (.txt)",
    "export.hintModrinth": "标准 .mrpack,可在本启动器或其它支持 Modrinth 的启动器中重新导入。",
    "export.hintCurseforge": "CurseForge 整合包 zip,含 manifest 与本地覆盖文件。",
    "export.hintModlist": "仅导出 mod 清单(名称/版本/链接),不打包文件,便于分享或存档。",
    "export.filter": "导出文件",
    "export.confirm": "导出",
  ...
  en: {
    ...
    "export.fmtModrinth": "Modrinth modpack (.mrpack)",
    "export.fmtCurseforge": "CurseForge modpack (.zip)",
    "export.fmtModlist": "Mod list",
    "export.subMd": "Markdown (.md)",
    "export.subHtml": "Web page (.html)",
    "export.subJson": "JSON (.json)",
    "export.subCsv": "CSV (.csv)",
    "export.subTxt": "Plain text (.txt)",
    "export.hintModrinth": "Standard .mrpack — re-importable here or in any Modrinth-compatible launcher.",
    "export.hintCurseforge": "CurseForge modpack zip with a manifest and local override files.",
    "export.hintModlist": "Just the mod list (name / version / link), no files bundled — handy to share or archive.",
    "export.filter": "Export file",
