...
const dict = {
  zh: {
    ...
    wikiTitle: "整合包 Wiki",
    wikiSubtitle: "查询当前整合包的本地资料、任务、玩法与配置说明。",
    wikiPlaceholder: "询问当前整合包的玩法、任务、配置或进度(Enter 发送,Shift+Enter 换行)",
    send: "发送",
    stop: "停止",
    streaming: "思考中…",
    queued: "已排队",
    ...
    wikiEmptyTitle: "查询当前整合包 Wiki",
    wikiEmptyHint: "例如:「这个整合包前期要做什么?」",
    debugToolsLabel: "调试",
  ...
  en: {
    ...
    wikiTitle: "Modpack Wiki",
    wikiSubtitle: "Search this modpack's local guides, quests, gameplay notes and config docs.",
    wikiPlaceholder: "Ask about this modpack's gameplay, quests, config or progression (Enter to send, Shift+Enter for a newline)",
    send: "Send",
    stop: "Stop",
    streaming: "Thinking…",
    queued: "Queued",
    ...
    wikiEmptyTitle: "Search this modpack's Wiki",
    wikiEmptyHint: "e.g. \"What should I do early in this pack?\"",
