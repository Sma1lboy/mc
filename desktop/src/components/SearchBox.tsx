  ...
  return (
    ...
    >
      ...
      <input
        ...
        class="flex-1 min-w-0 border-none bg-transparent text-fg text-[var(--fs-base)] font-[inherit] placeholder:text-faint focus-visible:outline-none"
        type="text"
      ...
      <Show when={props.value.length > 0}>
        <button
          ...
          class="shrink-0 inline-flex items-center justify-center w-[18px] h-[18px] border-none bg-transparent text-dim cursor-pointer rounded-none transition-[color,background-color] duration-[var(--dur)] ease-app hover:text-fg hover:bg-panel-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
