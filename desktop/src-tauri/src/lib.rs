...
pub fn specta_builder() -> Builder<tauri::Wry> {
    ...
    Builder::<tauri::Wry>::new()
        ...
        .commands(collect_commands![
            ...
            commands::kobe_save_credentials,
            commands::kobe_list_credentials,
            commands::kobe_remove_credentials,
            commands::kobe_set_auto_login,
            commands::realm_list,
            commands::realm_get,
            ...
            commands::realm_set_host,
            commands::realm_get_host,
            commands::realm_clear_host,
            commands::detect_lan_world,
            ...
            commands::agent_tool_validate_modpack_plan,
