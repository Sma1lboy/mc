...
export const inspectBaseModpack = () =>
  tool({
    description:
      "Inspect a base modpack: select an exact compatible version, download its archive, list the mods it already includes, and report the feature categories it covers. Returns the trusted version_id to pass unchanged to validate_modpack_plan, build_modpack, or show_modpack.",
